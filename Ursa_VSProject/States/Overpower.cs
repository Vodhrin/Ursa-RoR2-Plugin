...
namespace Ursa.States
{
    ...
    class Overpower : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            Core.Utils.PlayNetworkedSound(Core.Assets.ursaOverpowerSound, base.gameObject);

            this.stacks = base.skillLocator.secondary.stock + 1;
            base.skillLocator.secondary.stock = 0;

            Core.Utils.ApplyNetworkedTimedBuff(base.gameObject, UrsaPlugin.overpowerBuff, this.stacks, Overpower.buffDuration);
